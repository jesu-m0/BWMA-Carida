...
import { GeocoderResponse } from '../models/geocoder-response.module';
...
export class GeocodingService {
  ...
  getLocation(term: string): Observable<GeocoderResponse> {
    const url = `https://maps.google.com/maps/api/geocode/json?address=${term}&sensor=false&key=AIzaSyDK4RQ7DOu3WPC9GPfOrPlT4cmXYVv-jME`;
